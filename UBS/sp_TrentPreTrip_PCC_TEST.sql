/****** Cannot script Unresolved Entities : Server[@Name='TTXPASQL01']/Database[@Name='TMAN_UBS']/UnresolvedEntity[@Name='sp_PreTrip_Procedures' and @Schema='dbo'] ******/
GO

/****** Object:  StoredProcedure [dbo].[sp_LogProcErrors]    Script Date: 7/13/2015 12:38:13 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [dbo].[sp_TrentPreTrip_PCC_TEST]    Script Date: 7/13/2015 12:38:13 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER AUTHORIZATION ON [dbo].[sp_TrentPreTrip_PCC_TEST] TO  SCHEMA OWNER 
GO

/****** Object:  Table [DBA].[ProcedureLogs]    Script Date: 7/13/2015 12:38:13 PM ******/
SET ANSI_NULLS ON
GO
